...
export class DistributorService {
  ...
  getDistributorsLeadsBySearchFilter(BrandFilterDto: any): Observable<any[]> {
    return this._httpClient.post<any[]>(this.webAPIUrl + 'GetDistributorsLeadsBySearchFilter', JSON.stringify(BrandFilterDto), this.httpOptions);
  }
